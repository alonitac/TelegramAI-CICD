pipeline {
    ...
    stages {
        stage('Build') {
            steps {
                sh '''
                docker build -f bot/Dockerfile -t 700935310038.dkr.ecr.us-east-1.amazonaws.com/tamir/jenkins/bot:latest .
                ...
                aws ecr create-repository --repository-name tamir/jenkins/bot-test --region us-east-1
